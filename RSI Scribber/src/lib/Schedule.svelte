<script lang="ts">
  ...
  let openehr, ehrscape, username, password, ehrId, patientName, dob, patientId, cusultationType, htmlClincalNotes, htmlPatientInstructions, htmlDetailedReport, currentOption;
  let loading = false;
  let dateVal;
  let ctype = "1";
  let axiosConfig = {

<script lang="ts">
    ...
    let openehr, ehrscape, username, password, ehrId, patientName, dob, cusultationType, htmlClincalNotes, htmlPatientInstructions, htmlDetailedReport,currentOption;
    let data: any[] = [];
    onMount(async () => {
